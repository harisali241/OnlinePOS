...
INSERT INTO `account_natures` (`id`, `nature_name`) VALUES
(1, 'test');

-- --------------------------------------------------------

--
-- Table structure for table `adminmenu_premits`
--

DROP TABLE IF EXISTS `adminmenu_premits`;
CREATE TABLE IF NOT EXISTS `adminmenu_premits` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
(2, 5, 'Abcd Branch', 651651, 'Zee Papar', '41.0645819', -73.8611145, 1, '2018-07-04 01:56:49', '2018-07-04 01:56:49'),
(3, 5, 'Bartalomio', 99999, 'luffy', '32.8095005', -96.8376694, 1, '2018-07-08 07:23:40', '2018-07-08 07:23:40'),
(4, 5, 'Hodi Jones', 8585, 'fish Iland', '28.5596762', -81.3047409, 1, '2018-07-08 07:24:18', '2018-07-08 07:24:18');
...
INSERT INTO `countries2` (`id`, `sortname`, `name`, `phonecode`) VALUES
(1, 'AF', 'Afghanistan', 93),
(2, 'AL', 'Albania', 355),
(3, 'DZ', 'Algeria', 213),
...
INSERT INTO `inventories` (`id`, `account_id`, `company_id`, `user_id`, `branch_id`, `item_name`, `item_desc`, `opening_qty`, `alert_qty`, `status`, `created_at`, `updated_at`) VALUES
(1, 2, 5, 4, 2, 'Shampoo Sunsilk', 'asasg', 100, 12, 1, '2018-07-05 04:00:18', '2018-07-06 11:54:14'),
(2, 2, 5, 4, 3, 'Super Biscuit', 'Super Hai Zindagi', 0, 20, 1, '2018-07-08 07:27:08', '2018-07-08 07:27:08'),
(3, 2, 5, 4, 4, 'Lays', 'Chipas', 20, 11, 1, '2018-07-08 07:27:43', '2018-07-08 07:27:43'),
(4, 2, 5, 4, 2, 'Candy', 'Candyland ki candy. candy hai ye candy', 90, 30, 1, '2018-07-08 07:28:37', '2018-07-08 07:28:37'),
(5, 2, 5, 4, 3, '1 Rps waly Papar', 'local maal', 0, 80, 1, '2018-07-08 07:29:11', '2018-07-08 07:29:11'),
(6, 2, 5, 4, 3, 'bubleGum', 'bubleGum', 500, 70, 1, '2018-07-08 07:29:41', '2018-07-08 07:29:41');
...
(77, '2018_06_04_062919_create_roles_table', 1),
(97, '2018_05_23_220131_create_companies_table', 2),
(98, '2018_05_23_220629_create_branches_table', 2),
(99, '2018_05_23_221145_create_users_table', 2),
(100, '2018_05_23_221231_create_password_resets_table', 2),
(101, '2018_05_23_221441_create_terminals_table', 2),
(102, '2018_05_25_140402_create_account_natures_table', 2),
(103, '2018_05_25_140846_create_accounts_table', 2),
(104, '2018_05_25_151011_create_vendors_table', 2),
(105, '2018_05_25_151115_create_customers_table', 2),
(106, '2018_05_25_151249_create_inventories_table', 2),
(107, '2018_05_25_151525_create_purchase_masters_table', 2),
(108, '2018_05_25_151546_create_purchase_details_table', 2),
(109, '2018_05_25_151610_create_sale_masters_table', 2),
...
CREATE TABLE IF NOT EXISTS `states` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4121 DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `accounts`
  ...
  ADD CONSTRAINT `accounts_nature_id_foreign` FOREIGN KEY (`nature_id`) REFERENCES `account_natures` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `accounts_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `adminmenu_premits`
--
ALTER TABLE `adminmenu_premits`
  ADD CONSTRAINT `adminmenu_premits_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `g_r_n_masters`
  ...
  ADD CONSTRAINT `g_r_n_masters_purchase_id_foreign` FOREIGN KEY (`purchase_id`) REFERENCES `purchase_masters` (`id`) ON DELETE CASCADE,
